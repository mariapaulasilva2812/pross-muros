...
header( 'Content-type: application/json' );
    ...
    $datos = $_POST;
    $para           = 'cristobal.alvarez.gutierrez@gmail.com';
    $asunto         = strip_tags($_POST['nombre'].' ha enviado una consulta.');
    $email          = strip_tags($_POST['correo']);
    $telefono       = strip_tags($_POST['telefono']);
    $nombre         = strip_tags($_POST['nombre']);
    $mensaje        = nl2br( htmlspecialchars($_POST['consulta'], ENT_QUOTES) );
    ...
    $mensajeHtml .='    </head>';
    $mensajeHtml .='    <body>';
    $mensajeHtml .='    <h2><u></u> ha ingresado la siguiente consulta:</h2>';
    $mensajeHtml .='    </body>';
    $mensajeHtml .='</html>';
